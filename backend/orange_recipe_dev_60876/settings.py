"""
Django settings for orange_recipe_dev_60876 project.
...
ROOT_URLCONF = 'orange_recipe_dev_60876.urls'
...
WSGI_APPLICATION = 'orange_recipe_dev_60876.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_recipe_dev_60876 API",
    "DESCRIPTION": "API documentation for orange_recipe_dev_60876 App",
    "VERSION": "v1",
}
